...
int main(){
	...
	do{		
		...
		// Se o código nunca entrou na condição (matricula digitada = matricula uma das posições) a matrícula é única e pode ser adicionada no vetor de matrículas digitadas.
		strcpy(matricula[contador], matriculaDigitada);
		
		printf("Agora, insira o salário desse funcionário: ");
