...
int main(){
	...
	printf("Insira uma idade menor ou igual a zero para finalizar o cadastro de idades\n\n");
	for(int i = 0; i<100; i++){
	...
	for(int contador2 = 0; contador2 < quantidadeIdades; contador2++){
		// Se a posição em questão tiver o mesmo valor de maiorIdade, ele salva essa posição no vetor vezesMaiorSeRepete e ainda aumenta um numero na quantidade de vezes que o maior número se repete.
